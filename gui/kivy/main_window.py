...
from electrum_rby.bitcoin import TYPE_ADDRESS
from electrum_rby import WalletStorage, Wallet
from electrum_rby_gui.kivy.i18n import _
from electrum_rby.paymentrequest import InvoiceStore
from electrum_rby.util import profiler, InvalidPassword
from electrum_rby.plugins import run_hook
from electrum_rby.util import format_satoshis, format_satoshis_plain
from electrum_rby.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrum_rby_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_rby_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_rby_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_rby_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_rby_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_rby_gui.kivy.uix.screens')
...
from electrum_rby.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_rby.network import DEFAULT_PORTS
    ...
    def on_qr(self, data):
        from electrum_rby.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_rby.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_rby.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_rby_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_rby_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_rby_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_rby_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-rby.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-rby', message,
                            app_icon=icon, app_name='Electrum-rby')
        except ImportError:
