...
from electrum_rby.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_rby import bitcoin
from electrum_rby.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrum_rby.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_rby.util import create_URI
