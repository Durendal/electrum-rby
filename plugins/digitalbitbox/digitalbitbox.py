...
try:
    ...
    from electrum_rby.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_rby.transaction import Transaction
    from electrum_rby.i18n import _
    from electrum_rby.keystore import Hardware_KeyStore
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-RBY-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf").encode('utf8')
