...
from electrum_rby.plugins import hook, DeviceMgr
from electrum_rby.util import PrintError, UserCancelled, bh2u
from electrum_rby.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_rby.keystore import is_xprv
